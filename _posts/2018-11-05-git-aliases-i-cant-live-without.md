...
Note that `current_branch` is a custom function (made by the author of *oh-my-zsh*). You can see it e.g. [here](https://github.com/mjkonarski/oh-my-git-aliases/blob/master/oh-my-git-aliases.sh#L71).
